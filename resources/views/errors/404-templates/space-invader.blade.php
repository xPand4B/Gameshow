...
@section('error.style')
    <style>
        * {
        ...
        .bg-gradient {
            background-image: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); height: 100%;
        }
...
@section('error.content')
    <div class="wrapper">
        <div class="bg-gradient">
            <p class="center">@lang('errors.404.space-invader.title')
                <br/>
                @lang('errors.404.space-invader.constructions')
                <button class="btn btn-primary btn-sm" id="restart">
                    @lang('errors.404.space-invader.restart')
                </button>
            </p>
    ...
    ;(function() {
        ...
        Game.prototype = {
            ...
            if (this.lost) {
                ...
                screen.fillText("<?=trans('errors.404.space-invader.lost');?>", gameSize.width / 2, gameSize.height / 2);
                screen.font = "20px Lucida Console";
                screen.fillText("<?=trans('errors.404.space-invader.points');?>: " + kills, gameSize.width / 2, gameSize.height / 2 + 30);
                ...
                screen.fillText("<?=trans('errors.404.space-invader.points');?>: " + kills, gameSize.width, gameSize.height - 12);
            }
