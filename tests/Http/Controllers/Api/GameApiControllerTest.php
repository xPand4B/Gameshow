...
class GameApiControllerTest extends TestCase
{
    ...
    public function test_game_api_controller_can_store_new_game(): void
    {
        ...
        $response = $this
            ->actingAsUser()
            ->json('POST', route(self::STORE_ROUTE), ['username' => $this->user->username])
            ->assertStatus(200);
    ...
    public function test_game_api_controller_can_return_running_game(): void
    {
        ...
        self::assertSame([
            'data' => (new GameResource($game->fresh()))->toArray(new Request())
        ], json_decode($response->getContent(), true));
    }
    ...
    public function test_game_api_controller_can_show(): void
    {
        ...
        $response = $this
            ->actingAsUser()
            ->json('GET', route(self::SHOW_ROUTE, ['gameId' => $game->id]))
            ->assertStatus(200);
    ...
    public function test_game_api_controller_can_tell_if_exists(): void
    {
        ...
        $response = $this
            ->actingAsUser()
            ->json('GET', route(self::EXIST_ROUTE, ['gameId' => $game->id]))
            ->assertStatus(200);
    ...
    public function test_game_api_controller_can_update(): void
    {
        ...
        $response = $this
            ->actingAsUser()
            ->json('PATCH', route(self::UPDATE_ROUTE, ['gameId' => $game->id]), $payload)
            ->assertStatus(200);
    ...
    public function test_game_api_controller_can_destroy(): void
    {
        ...
        $response = $this
            ->actingAsUser()
            ->json('DELETE', route(self::DESTROY_ROUTE, ['gameId' => $game->id]))
            ->assertStatus(200);
